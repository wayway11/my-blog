...
- 配置项目部署到腾讯云 EdgeOne Pages（支持 GitHub 仓库对接，push 自动构建部署）
...
- `edgeone-deploy`: 将 Astro 静态站点部署到腾讯云 EdgeOne Pages，通过 GitHub 仓库对接实现 git push 自动构建和部署，国内 CDN 加速分发
...
- 需要腾讯云账号、EdgeOne Pages 服务开通、域名及 ICP 备案
